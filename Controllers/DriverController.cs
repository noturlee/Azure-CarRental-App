...
namespace THERIDEURENT1.Controllers
{
    public class DriverController : Controller
    {
        ...
        public DriverController(TheRideYouRentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Drivers != null ? 
                          ...
                          Problem("Entity set 'TheRideYouRentContext.Drivers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TheRideYouRentContext.Drivers'  is null.");
            }
            var driver = await _context.Drivers.FindAsync(id);
            if (driver != null)
            {
